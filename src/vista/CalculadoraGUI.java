...
import modelo.funciones.operaciones.FResta;
import modelo.funciones.Funcion;
import modelo.funciones.operaciones.FSQR;
...
import modelo.*;
import modelo.funciones.memoria.FMemoryAdd;
import modelo.funciones.memoria.FMemoryClear;
import modelo.funciones.memoria.FMemoryReCall;
import modelo.funciones.memoria.FMemoryStore;
import modelo.funciones.memoria.FMemorySubs;
...
public class CalculadoraGUI extends javax.swing.JFrame {
    ...
    Calculadora calc;
    boolean previousThingWasAnError = false;
    boolean tengoQueBorrarPantallaAntesDeEscribir = false;
    boolean ultimaOperacionEsMemoryClear = false;
    ...
    public CalculadoraGUI() {
        initComponents();
        //this.jTextFieldPantalla.setBackground(Color.yellow);
    ...
    private void initComponents() {
        ...
        jTextFieldPantalla1 = new javax.swing.JTextField();
        ...
        whichFunction = new javax.swing.JTextField();

        jTextFieldPantalla1.setBackground(new java.awt.Color(64, 151, 94));
        jTextFieldPantalla1.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        jTextFieldPantalla1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldPantalla1ActionPerformed(evt);
            }
        });

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jTextFieldPantalla.setBackground(new java.awt.Color(0, 204, 204));
        jTextFieldPantalla.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        jTextFieldPantalla.setCaretColor(new java.awt.Color(204, 0, 51));
        jTextFieldPantalla.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jTextFieldPantalla.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldPantallaActionPerformed(evt);
            }
        });
        ...
        whichFunction.setBackground(new java.awt.Color(255, 255, 255));
        whichFunction.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        whichFunction.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                whichFunctionActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jTextFieldPantalla, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(whichFunction, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(whichFunction, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonMasMenos)
                    .addComponent(jButtonSQR)
    ...
    {//GEN-HEADEREND:event_jButton7ActionPerformed
        //actualizaPantalla("7");
        numero.append('7');
        actualizaPantalla('7' + "");//la vista se encarga de la vista fcking logic
    ...
    private void queTenianLasFuncionesEnComun(Funcion funcion) {
        if (!enviarOperando()) {
            return;
        }
        if (calc.addOperand(funcion).equals("E")) {
            previousThingWasAnError = true;
            jTextFieldPantalla.setText("ERROR");
        } else {

            whichFunction.setText(funcion.toString2());
            clearPantalla();
        }
    }
    ...
    private void jButtonMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMenosActionPerformed
        queTenianLasFuncionesEnComun(new FResta());
    ...
    private void jButtonIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIgualActionPerformed
        ...
        String cuerdaDeDoceCaracteres = calc.equal().toEngineeringString();
        clearPantalla();
        try {
            cuerdaDeDoceCaracteres = cuerdaDeDoceCaracteres.substring(0, 10);
        } catch (Exception e) {
            cuerdaDeDoceCaracteres = cuerdaDeDoceCaracteres.substring(0, cuerdaDeDoceCaracteres.length());
        }
        actualizaPantalla(cuerdaDeDoceCaracteres);
        tengoQueBorrarPantallaAntesDeEscribir = true;
        whichFunction.setText('=' + "");
        if(ultimaOperacionEsMemoryClear)
    ...
    private void jButtonMasMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMasMenosActionPerformed
        queTenianLasFuncionesEnComun(new FCambioSigno());
    ...
    private void jButtonSQRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSQRActionPerformed
        queTenianLasFuncionesEnComun(new FSQR());
    ...
    private void jButtonSQRTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSQRTActionPerformed
        queTenianLasFuncionesEnComun(new FSQRT());
    ...
    private void jButton1DivXActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1DivXActionPerformed
        queTenianLasFuncionesEnComun(new FInversa());
    ...
    private void jButtonMRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMRActionPerformed
        ...
        ultimaOperacionEsMemoryClear = false;
    ...
    private void jButtonMCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMCActionPerformed
        ...
        ultimaOperacionEsMemoryClear = true;
    ...
    private void jTextFieldPantallaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldPantallaActionPerformed
        // TODO add your handling code here:
        // TODO delete TODO
        jButtonIgualActionPerformed(evt);
    }//GEN-LAST:event_jTextFieldPantallaActionPerformed

    private void jTextFieldPantalla1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldPantalla1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldPantalla1ActionPerformed

    private void whichFunctionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_whichFunctionActionPerformed
        // TODO add  your handling code here:
    }//GEN-LAST:event_whichFunctionActionPerformed

    private void actualizaPantalla(String s) {
        if (previousThingWasAnError || tengoQueBorrarPantallaAntesDeEscribir) {
            clearPantalla();
        }
        jTextFieldPantalla.setText(jTextFieldPantalla.getText() + s);
        tengoQueBorrarPantallaAntesDeEscribir = false;
        previousThingWasAnError = false;
    }
    ...
    /**
     * envia el operando(numero) a la calculadora
     */
    private boolean enviarOperando() {
        if (calc.addOperand(extrujarNumero()).equals("E")) {
            previousThingWasAnError = true;
            jTextFieldPantalla.setText("ERROR");
            return false;
        }
    ...
    private javax.swing.JTextField jTextFieldPantalla1;
    private javax.swing.JTextField whichFunction;
